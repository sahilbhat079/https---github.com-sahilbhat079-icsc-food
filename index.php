                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose kitchens </h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a restaurant or kitchen</h3>
                                    <p>We've got your covered with menus from over 300 delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured restaurants and cloud kitchens </h4> </div>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Choose restaurant or kitchen</a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>project for education purpose</p>
